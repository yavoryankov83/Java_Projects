...
import com.telerikacademy.workItemManagement.commands.showCommands.ListAllWorkItemsSortedByPriority;
...
public class ListWorkItemSortedByPriority_Tests {
    ...
    public void before() {
        ...
        testCommand = new ListAllWorkItemsSortedByPriority(testRepository);
    ...
    public void execute_should_list_workItem_when_inputIsValid() {
        ...
        result
                .append(String.format("Work item %s with title %s - Priority: %s%n",
                        testStory.getType(),
                        testStory.getTitle(),
                        testStory.getPriority()));
